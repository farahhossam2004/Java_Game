...
//=================================================================
    ...
    Image[] fruitimages = {
        ...
        new Image(getClass().getResourceAsStream("../../resources/Images/fruits/greenGrapes.png")),
        new Image(getClass().getResourceAsStream("../../resources/Images/fruits/pinnable.png")),
        new Image(getClass().getResourceAsStream("../../resources/Images/fruits/redGrapes.png")),
        new Image(getClass().getResourceAsStream("../../resources/Images/fruits/banana.png")),
    };
    ...
    Image[] SlicedFruitimages = {
        ...
        new Image(getClass().getResourceAsStream("../../resources/Images/sliced_fruit/green_grapes2.png")),
        new Image(getClass().getResourceAsStream("../../resources/Images/sliced_fruit/pinnable.png")),
        new Image(getClass().getResourceAsStream("../../resources/Images/sliced_fruit/red_grapes.png")),
        new Image(getClass().getResourceAsStream("../../resources/Images/sliced_fruit/banana.png")),
    };
...
//==========================
                // to calculate your score and from sliced image index will calculate it WaterMelon 0 banana 1  greengrape 2 pinneapple 3 redgrapes 4
                ...
                switch (index) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        UserScore = UserScore+Fruit.GetGreenGrapesScore();
                        score.setText(String.valueOf(UserScore));
                        break;
                    case 3 : 
                        UserScore = UserScore + Fruit.GetPinneappleScore();
                        score.setText(String.valueOf(UserScore));
                        break;
                    case 4 : 
...
//=================================================================================
    ...
    {
        Level level = new Level(UserScore, 5);
    ...
    public void SwitchToLevel6Scene(ActionEvent e)throws IOException{
        ...
        root = FXMLLoader.load(getClass().getResource("../view/LevelScene.fxml"));
    ...
    public void TryAgainLevel5(ActionEvent e)throws IOException{
        ...
        root = FXMLLoader.load(getClass().getResource("../view/Level5.fxml"));
        scene= new Scene(root);
        stage.setScene(scene);
        stage.show();
    }
